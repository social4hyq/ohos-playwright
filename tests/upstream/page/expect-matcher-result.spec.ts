...
import { stripAnsi } from '../fixtures/upstream-utils.js';
import { test, expect } from '../fixtures/upstream-fixture.js';
...
test('toHaveScreenshot should populate matcherResult', async ({ page, server, isAndroid }) => {
  test.skip(isAndroid);
  it.fixme(true, 'ArkWeb: toHaveScreenshot 失败时不 populate matcherResult（截图/diff 流程差异）');

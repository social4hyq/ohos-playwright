...
import type { CommonFixtures, CommonWorkerFixtures, TestChildProcess } from '../../playwright-official/tests/config/commonFixtures';
import { commonFixtures } from '../../playwright-official/tests/config/commonFixtures';
import type { ServerFixtures, ServerWorkerOptions } from '../../playwright-official/tests/config/serverFixtures';
import { serverFixtures } from '../../playwright-official/tests/config/serverFixtures';
import type { TestInfo } from '../../playwright-official/tests/playwright-test/stable-test-runner';
import { expect } from '../../playwright-official/tests/playwright-test/stable-test-runner';
import { test as base } from '../../playwright-official/tests/playwright-test/stable-test-runner';
import { inheritAndCleanEnv } from '../../playwright-official/tests/config/utils';
export { countTimes } from '../../playwright-official/tests/config/commonFixtures';
...
// Forked for ohos-playwright: redirect to our own dist/cli.mjs (the @playwright/test bin we ship).
// __dirname here is probes/playwright-test/, so ../../dist/cli.mjs resolves to ohos-playwright/dist/cli.mjs.
export const cliEntrypoint = path.resolve(__dirname, '../../dist/cli.mjs');
...
export { expect } from '../../playwright-official/tests/playwright-test/stable-test-runner';
